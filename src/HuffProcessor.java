...
public class HuffProcessor {
	...
	private void codingHelper(HuffNode root, String string, String[] encodings) {
			...
			if (root.myRight!=null) codingHelper (root.myRight,string + "1",encodings);
			if (root.myLeft!=null) codingHelper (root.myLeft,string + "0", encodings);
	}
	...
	private HuffNode readTreeHeader(BitInputStream in) {
		...
		if (bit == -1) throw new NullPointerException ("Nothing is read.");
		if (bit == 0) {
